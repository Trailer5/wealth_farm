...
- 4月7日停火，但**物理修复仍需3-5年**（受制于全球透平机短缺，非资金限制）
...
- 市值$193M vs TAM$50亿 = 3.9%，低于20%红线，但**完全依赖未来预期**

**估值安全边际检验**：无法做10年25xPE退出法（无收入、无储量认定）→ 不具备安全边际基础

**风险**：
1. 无储量（No reserves assigned）——最大风险
2. 生产时间表不确定（mid-2026 production decision ≠ 生产）
3. 持续稀释融资风险（探索阶段）
4. 氦气瓶颈可能在Pulsar投产前被部分解决（其他供给来源）
...
- **PGME/PGMEA S级**：June 15外限**剩8天**，停火不改变短缺，红色警戒不变
- **WF6 S级**：Day~78，H2减产区持续，Kanto Denka独家，不变
- **Centrus Option 1b**：仍零公告，AGM June 18（**12天**），最高优先级
- **Almonty Phase 2**：投票**明日（June 8）**，AGM June 9（3天），未见生产数据今日发布
